...
for i,p in enumerate(orders):
   ...
   i1=plt.axes([0.4,0.175,0.33,0.5])
...
#           plt.plot(x,T,label=zelab)
            ...
            i1.set_xlim((0.45,0.85)) # need to start storing and
            i1.set_ylim((0.926,0.9325))# func-ifying these xlims
            i1.set_xticks([0.5,0.6,0.7,0.8])
            i1.set_yticks([0.926,0.928,0.93,0.932])
            i1.plot(x,u)
